...
export const DUMMY_PROJECTS = [
  ...
  image: `https://loremflickr.com/800/600/technology,computer,software/all?lock=${idx + 100}`,
...
export function getUniqueProjectsForMember(member, count = 3) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    generatedProjects.push({
      ...
      image: `https://loremflickr.com/800/600/${imgKeyword}/all?lock=${curSeed * 7 + 100}`,
      keyword: imgKeyword
    });
  }
