...
const SERVICES = [
  {
    ...
    tools: [
      ...
      { img: "Powerapps.png.png", label: "Power Apps" },
      { img: "powerbi.png.png", label: "Power BI", boost: true },
      { img: "msteam.png.png", label: "MS Teams" },
    ],
  },
  {
    color: "var(--green)",
    ...
    tools: [
      { img: "pyth.png.png", label: "Python" },
      { img: "automate.png.png", label: "Power Automate", boost: true },
      { img: "excel.png.png", label: "MS Excel" },
      { img: "sql.png.png", label: "SQL Server" },
      { img: "azure.png.png", label: "MS Azure" },
    ],
  },
  {
    color: "var(--blue)",
    ...
    tools: [
      { img: "node.png.png", label: "Node.js" },
      { img: "docker.png.png", label: "Docker" },
      { img: "mongo.png.png", label: "MongoDB" },
      { img: "azure.png.png", label: "Microsoft Azure" },
      { img: "automate.png.png", label: "Power Automate", boost: true },
    ],
  },
  {
    ...
    tools: [
      { img: "automate.png.png", label: "Power Automate", boost: true },
      { img: "out.png.png", label: "MS Outlook" },
      { img: "powerbi.png.png", label: "Power BI", boost: true },
      { img: "excel.png.png", label: "MS Excel" },
      { img: "sql.png.png", label: "SQL Server" },
    ],
  },
  {
    ...
    tools: [
      ...
      { img: "excel.png.png", label: "MS Excel" },
      { img: "powerbi.png.png", label: "Power BI", boost: true },
      { img: "word.png.png", label: "MS Word" },
    ],
  },
  {
    color: "var(--green)",
    ...
    tools: [
      { img: "react.png.png", label: "React.js" },
      { img: "ang.png.png", label: "Angular" },
      { img: "node.png.png", label: "Node.js" },
      { img: "djan.png.png", label: "Django" },
      { img: "aws.png.png", label: "AWS" },
    ],
  },
];
